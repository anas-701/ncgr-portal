...
@Component({
  selector: 'app-admin-about-content-component',
  imports: [CommonModule, ReactiveFormsModule,TextEditor],
  templateUrl: './admin-about-content-component.component.html',
  styleUrl: './admin-about-content-component.component.scss'
})
export class AdminAboutContentComponentComponent {
